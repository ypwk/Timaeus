export const arataki_itto_data = {
    "id": "arataki_itto",
    ...
    "constellations": [
      {
        ...
        "description": "After using <span style=\"color: #FFD780FF;\">Royal Descent: Behold, Itto the Evil!</span>, Arataki Itto gains 2 stacks of Superlative Superstrength. After 1s, Itto will gain 1 stack of Superlative Superstrength every 0.5s for 1.5s."
      },
      {
        "name": "Gather 'Round, It's a Brawl!",
        "description": "After using <span style=\"color: #FFD780FF;\">Royal Descent: Behold, Itto the Evil!</span>, each party member whose Element is <span style=\"color: #FFE699FF;\">Geo</span> will decrease that skill's CD by 1.5s and restore 6 Energy to Arataki Itto.\\nCD can be decreased by up to 4.5s in this manner. Max 18 Energy can be restored in this manner."
      },
      {
        "name": "Horns Lowered, Coming Through",
        "description": "Increases the Level of <span style=\"color: #FFD780FF;\">Masatsu Zetsugi: Akaushi Burst!</span> by 3.\\nMaximum upgrade level is 15."
      },
      {
        "name": "Jailhouse Bread and Butter",
        "description": "When the Raging Oni King state caused by <span style=\"color: #FFD780FF;\">Royal Descent: Behold, Itto the Evil!</span> ends, all nearby party members gain 20% DEF and 20% ATK for 10s."
      },
      {
        "name": "10 Years of Hanamizaka Fame",
        "description": "Increases the Level of <span style=\"color: #FFD780FF;\">Royal Descent: Behold, Itto the Evil!</span> by 3.\\nMaximum upgrade level is 15."
      },
      {
