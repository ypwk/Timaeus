    ...
    "constellations": [
      {
        ...
        "description": "While <span style=\"color: #FFD780FF;\">Sweeping Time</span> and <span style=\"color: #FFD780FF;\">Breastplate</span> are both in effect, the chance of Breastplate's healing effects activating is increased to 100%."
      },
      {
        "name": "Combat Maid",
      ...
      },
      {
        ...
        "description": "Increases the Level of <span style=\"color: #FFD780FF;\">Breastplate</span> by 3.\\nMaximum upgrade level is 15."
      },
      {
        "name": "To Be Cleaned",
        "description": "When <span style=\"color: #FFD780FF;\">Breastplate</span>'s duration expires or it is destroyed by DMG, it will deal 400% ATK of <span style=\"color: #FFE699FF;\">Geo DMG</span> to surrounding opponents."
      },
      {
        "name": "Favonius Sweeper Master",
        "description": "Increases the Level of <span style=\"color: #FFD780FF;\">Sweeping Time</span> by 3.\\nMaximum upgrade level is 15."
      },
      {
        "name": "Must Be Spotless",
        "description": "<span style=\"color: #FFD780FF;\">Sweeping Time</span> increases Noelle's ATK by an additional 50% of her DEF.\\nAdditionally, every opponent defeated during the skill's duration adds 1s to the duration, up to 10s."
      }
    ],
    "passives": [
      {
        "name": "Devotion",
        "description": "When Noelle is in the party but not on the field, this ability triggers automatically when your active character's HP falls below 30%:\\nCreates a shield for your active character that lasts for 20s and absorbs DMG equal to 400% of Noelle's DEF.\\nThe shield has a 150% DMG Absorption effectiveness against all Elemental and Physical DMG.\\nThis effect can only occur once every 60s."
      },
      {
        "name": "Nice and Clean",
        "description": "Every 4 Normal or Charged Attack hits will decrease the CD of <span style=\"color: #FFD780FF;\">Breastplate</span> by 1s.\\nHitting multiple opponents with a single attack is only counted as 1 hit."
      },
      {
