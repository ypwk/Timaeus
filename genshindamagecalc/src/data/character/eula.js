export const eula_data = {
    ...
    "constellations": [
      {
        "name": "Tidal Illusion",
        "description": "Every time <span style=\"color: #FFD780FF;\">Icetide Vortex</span>'s Grimheart stacks are consumed, Eula's Physical DMG is increased by 30% for 6s.\\nEach stack consumed will increase the duration of this effect by 6s up to a maximum of 18s."
      },
      {
        "name": "Lady of Seafoam",
        "description": "Decreases the CD of <span style=\"color: #FFD780FF;\">Icetide Vortex</span>'s Holding Mode, rendering it identical to Press CD."
      },
      {
        "name": "Lawrence Pedigree",
        "description": "Increases the Level of <span style=\"color: #FFD780FF;\">Glacial Illumination</span> by 3.\\nMaximum upgrade level is 15."
      },
      {
      ...
      },
      {
        ...
        "description": "Increases the Level of <span style=\"color: #FFD780FF;\">Icetide Vortex</span> by 3.\\nMaximum upgrade level is 15."
      },
      {
        "name": "Noble Obligation",
        "description": "Lightfall Swords created by <span style=\"color: #FFD780FF;\">Glacial Illumination</span> start with 5 stacks of energy. Normal Attacks, Elemental Skills, and Elemental Bursts have a 50% chance to grant the Lightfall Sword an additional stack of energy."
      }
    ],
    "passives": [
      {
        "name": "Roiling Rime",
        "description": "If 2 stacks of Grimheart are consumed upon unleashing the Holding Mode of <span style=\"color: #FFD780FF;\">Icetide Vortex</span>, a Shattered Lightfall Sword will be created that will explode immediately, dealing 50% of the basic Physical DMG dealt by a Lightfall Sword created by <span style=\"color: #FFD780FF;\">Glacial Illumination</span>."
      },
      {
        "name": "Wellspring of War-Lust",
        "description": "When <span style=\"color: #FFD780FF;\">Glacial Illumination</span> is cast, the CD of <span style=\"color: #FFD780FF;\">Icetide Vortex</span> is reset and Eula gains 1 stack of Grimheart."
      },
      {
